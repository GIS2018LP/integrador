//BETO
            ...
            */
            ...
            //BETO
            var insertarDatos = function (coordinate) {
                    ...
                    //es un punto [lon,lat]
                    var punto = 'POINT(' + coordinate[0] + ' ' + coordinate[1] + ')';
                    ...
                    window.top.location.href = 'insertar.php?punto=' + punto + '&nombre=' + nombre + '&tipo=' + tipo + '&situacion=' + situacion + '&precision=' + precision + '&fuente=' + fuente +  '&operador=' + operador + '&responsable=' + responsable + '&cargo=' + cargo 
